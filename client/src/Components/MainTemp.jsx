...
const MainTemp = () => {
        ...
        if (Notification.permission === "default") {
            Notification.requestPermission(function (permission) {
              if (permission === "granted") {
                var notification = new Notification("Now We Will Notify You From Notifications");
              }
            });
        }
    ...
    try {
        ...
        showNotification({title:"Warning",message:`    We Have Found Immoral Activity From Your Side.
  ...
  Please Don't Repeat Such Type Of Mistake In Future.
   ...
   ${realTodoData[i].taskDetails} 
    ...
    const taskDeleteFunc = (i) => {
        showNotification({title:"Task Deleted",message:`    Hi, Your Task ${realTodoData[i].taskName} Is Deleted.`});
        let newData = realTodoData;
        let messTempData;
        if (userMiscData.isSimple === false) {
            messTempData = {
   ...
   ${realTodoData[i].taskDetails} 
    ...
    const taskExpiredFunc = (i) => {
        showNotification({title:"Task Expired",message:`    Hi, Your Task ${realTodoData[i].taskName} Is Expired.`});
        let newData = realTodoData;
