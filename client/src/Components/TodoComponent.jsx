                ...
                props.todoData.map((tempTodoData, i) => (
                    <div key={i} className="bodyDivChild">
                        <div className="todoModifier">
                            <div onClick={() => props.taskCompleteFunc(i)} style={tempTodoData.taskCompleted === false ? { visibility: "visible" } : { visibility: "hidden" }} className="todoDone todoModifierButtons"><span>Complete</span></div>
